...
public class AppCluster {
    ...
    public static void main(String[] args) {
        try{
            BufferedReader buf = new BufferedReader(new FileReader("/F:/sts-bundle/sts-3.8.4.RELEASE/agregation.txt"));
            ...
            ConnectedComponents concomp = new ConnectedComponents(linkedComponent);
            clusterArray.addAll(concomp.funcCall());
            FileWriter writer = new FileWriter("/F:/sts-bundle/output.txt");
